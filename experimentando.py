...
def insert_spatial_after_blocks(model: models.DenseNet, reduction: int = 16):
...
class A2SDNet121(nn.Module):
    def __init__(self, num_classes: int, pretrained: bool = True, reduction: int = 16):
        ...
        # insert SE blocks
        backbone = insert_spatial_after_blocks(backbone, reduction=reduction)
